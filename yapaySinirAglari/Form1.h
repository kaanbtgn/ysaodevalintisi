...
#pragma region Windows Form Designer generated code
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->menuStrip1->Size = System::Drawing::Size(1600, 28);
			   ...
			   this->readDataToolStripMenuItem->Size = System::Drawing::Size(185, 26);
			   ...
			   this->saveDataToolStripMenuItem->Size = System::Drawing::Size(185, 26);
			   ...
			   this->readWeightsToolStripMenuItem->Size = System::Drawing::Size(185, 26);
			   ...
			   this->saveWeightsToolStripMenuItem->Size = System::Drawing::Size(185, 26);
			   ...
			   // textBox1
			   // 
			   this->textBox1->Location = System::Drawing::Point(1323, 62);
			   this->textBox1->Margin = System::Windows::Forms::Padding(4);
			   this->textBox1->Multiline = true;
			   this->textBox1->Name = L"textBox1";
			   this->textBox1->Size = System::Drawing::Size(237, 394);
	...
	private: System::Void pictureBox1_MouseClick(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
		if (numClass == 0)
			...
			if (numLabel > numClass)
				...
				label = numLabel - 1; //Values start from 0, so subtract 1
				if (numSample == 0) {
    numSample = 1;
    // Allocate for 1 sample, which requires inputDim floats
		...
		if (file.is_open()) {
			...
			while (!file.eof()) {
				if (numSample == 0) {
					...
					if (!(file >> targets[0])) {
						break; // If reading label fails, break out
					}
				}
				else {
					for (int i = 0; i < inputDim; i++) {
			...
			for (int i = 0; i < numSample; i++) {
				...
				// Optional: display read samples in the textbox
